...
int main()
{
    ...
    system("cls");
    printf("\n\n\n");
   printf("_________________________________________________MENU______________________________________________________ \n\n\n");
...
printf("\n\n");
    printf("======================================================================================================\n");
 printf("\t\t\t\tYour change has been Returned\t\t\t\n");
    printf("======================================================================================================\n");
}
    ...
    do
{
	...
	i=0;
		...
		if(strcmp(uname,"Employee1")==0 && strcmp(pword,"password1")==0)
	{
	printf("  \n\n\n       LOGIN IS SUCCESSFUL!     ");
